            ...
            <div class="row">
                <div class="col-md-12 col-lg-7 m-auto">
                    <div class="title">
                        ...
                        <p class="mbr-section-subtitle align-left mbr-fonts-style mbr-white block-left display-7">В Конечно Можно мы используем диодный лазер. Это последнее поколение оборудования для лазерной эпиляции, которое помогает убрать волосы на теле на 2−5 лет без дискомфорта и рисков для здоровья.
